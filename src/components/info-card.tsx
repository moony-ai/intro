    ...
    <Card placeholder="">
      ...
      >
        <div className="flex flex-col gap-1 w-full">
          <Typography color="blue" className="font-bold text-xs" placeholder="">
            {date}
          </Typography>
          <Typography color="blue-gray" variant="h5" className="w-full" placeholder="">
            {title}
          </Typography>
        </div>
        <IconButton
      ...
      <CardBody className="grid justify-start !px-3.5 pt-2" placeholder="">
